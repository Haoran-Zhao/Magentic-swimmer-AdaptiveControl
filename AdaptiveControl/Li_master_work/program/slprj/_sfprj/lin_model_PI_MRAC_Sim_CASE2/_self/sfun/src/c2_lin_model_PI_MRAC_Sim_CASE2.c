...
static const char * c2_debug_family_names[5] = { "nargin", "nargout", "b", "A",
  "y" };

/* Function Declarations */
static void initialize_c2_lin_model_PI_MRAC_Sim_CASE2
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance);
static void initialize_params_c2_lin_model_PI_MRAC_Sim_CASE2
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance);
static void enable_c2_lin_model_PI_MRAC_Sim_CASE2
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance);
static void disable_c2_lin_model_PI_MRAC_Sim_CASE2
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_lin_model_PI_MRAC_Sim_CASE2
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_lin_model_PI_MRAC_Sim_CASE2
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance);
static void set_sim_state_c2_lin_model_PI_MRAC_Sim_CASE2
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance, const mxArray *
   c2_st);
static void finalize_c2_lin_model_PI_MRAC_Sim_CASE2
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance);
static void sf_c2_lin_model_PI_MRAC_Sim_CASE2
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance);
static void initSimStructsc2_lin_model_PI_MRAC_Sim_CASE2
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, const mxArray *c2_y, const char_T *c2_identifier, real_T
  c2_b_y[44]);
static void c2_b_emlrt_marshallIn(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
...
static void c2_mldivide(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, real_T c2_A[44], real_T c2_B[121], real_T c2_Y[44]);
static void c2_eml_scalar_eg(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance);
static void c2_eps(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance);
static real_T c2_sqrt(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
                      *chartInstance, real_T c2_x);
static void c2_eml_error(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance);
static real_T c2_eml_xnrm2(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, real_T c2_x[44], int32_T c2_ix0);
static real_T c2_ceval_xnrm2(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[44], int32_T c2_ix0, int32_T c2_incx);
static int32_T c2_eml_ixamax(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[4], int32_T c2_ix0);
static int32_T c2_ceval_ixamax(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[4], int32_T c2_ix0, int32_T c2_incx);
static void c2_eml_xswap(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, real_T c2_x[44], int32_T c2_ix0, int32_T c2_iy0, real_T
  c2_b_x[44]);
static void c2_ceval_xswap(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[44], int32_T c2_ix0, int32_T c2_incx,
  int32_T c2_iy0, int32_T c2_incy, real_T c2_b_x[44]);
static real_T c2_b_eml_xnrm2(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[44], int32_T c2_ix0);
static real_T c2_eml_dlapy2(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, real_T c2_x1, real_T c2_x2);
static void c2_eml_xscal(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x[44], int32_T c2_ix0,
  real_T c2_b_x[44]);
static void c2_ceval_xscal(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x[44], int32_T c2_ix0,
  int32_T c2_incx, real_T c2_b_x[44]);
static void c2_eml_matlab_zlarfg(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *
  chartInstance, real_T c2_alpha1, real_T c2_x, real_T *c2_b_alpha1, real_T
  *c2_b_x, real_T *c2_tau);
static real_T c2_b_eml_xscal(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, real_T c2_a, real_T c2_x);
static real_T c2_b_ceval_xscal(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x, int32_T c2_ix0,
  int32_T c2_incx);
static void c2_eml_matlab_zlarf(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_m, int32_T c2_n, int32_T c2_iv0, real_T c2_tau,
  real_T c2_C[44], int32_T c2_ic0, real_T c2_work[4], real_T c2_b_C[44], real_T
  c2_b_work[4]);
static void c2_eml_blas_xgemv(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
...
static void c2_ceval_xgemv(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_m, int32_T c2_n, real_T c2_alpha1, real_T c2_A[44],
  ...
  real_T c2_b_y[4]);
static void c2_ceval_xger(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
...
static void c2_eml_warning(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, real_T c2_varargin_2, char_T c2_varargin_3[14]);
static void c2_d_emlrt_marshallIn(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, const mxArray *c2_sprintf, const char_T *c2_identifier, char_T
  c2_y[14]);
static void c2_e_emlrt_marshallIn(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  char_T c2_y[14]);
...
static uint8_T c2_g_emlrt_marshallIn
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance, const mxArray *
   c2_b_is_active_c2_lin_model_PI_MRAC_Sim_CASE2, const char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance, const mxArray *
   c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sqrt(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
                      *chartInstance, real_T *c2_x);
static void c2_b_eml_xswap(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, real_T c2_x[44], int32_T c2_ix0, int32_T c2_iy0);
static void c2_b_ceval_xswap(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[44], int32_T c2_ix0, int32_T c2_incx,
  int32_T c2_iy0, int32_T c2_incy);
static void c2_c_eml_xscal(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x[44], int32_T c2_ix0);
static void c2_c_ceval_xscal(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x[44], int32_T c2_ix0,
  int32_T c2_incx);
static real_T c2_b_eml_matlab_zlarfg
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance, real_T
   *c2_alpha1, real_T *c2_x);
static void c2_d_eml_xscal(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, real_T c2_a, real_T *c2_x);
static void c2_d_ceval_xscal(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T *c2_x, int32_T c2_ix0,
  int32_T c2_incx);
static void c2_b_eml_matlab_zlarf(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_m, int32_T c2_n, int32_T c2_iv0, real_T c2_tau,
  real_T c2_C[44], int32_T c2_ic0, real_T c2_work[4]);
static void c2_b_eml_blas_xgemv(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_m, int32_T c2_n, real_T c2_A[44], int32_T c2_ia0,
  real_T c2_x[44], int32_T c2_ix0, real_T c2_y[4]);
static void c2_b_ceval_xgemv(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_m, int32_T c2_n, real_T c2_alpha1, real_T c2_A[44],
  int32_T c2_ia0, int32_T c2_lda, real_T c2_x[44], int32_T c2_ix0, int32_T
  c2_incx, real_T c2_beta1, real_T c2_y[4], int32_T c2_iy0, int32_T c2_incy);
static void c2_b_ceval_xger(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance, int32_T c2_m, int32_T c2_n, real_T c2_alpha1, int32_T c2_ix0,
  int32_T c2_incx, real_T c2_y[4], int32_T c2_iy0, int32_T c2_incy, real_T c2_A
  [44], int32_T c2_ia0, int32_T c2_lda);
static void init_dsm_address_info(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct
  *chartInstance);
  ...
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_lin_model_PI_MRAC_Sim_CASE2 = 0U;
}
  ...
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance)
{
  ...
  real_T (*c2_d_y)[44];
  c2_d_y = (real_T (*)[44])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_createcellarray(2));
  for (c2_i0 = 0; c2_i0 < 44; c2_i0++) {
    c2_u[c2_i0] = (*c2_d_y)[c2_i0];
  }

  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 2, 4, 11));
  sf_mex_setcell(c2_y, 0, c2_b_y);
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_lin_model_PI_MRAC_Sim_CASE2;
   ...
   c2_st)
{
  ...
  int32_T c2_i1;
  real_T (*c2_y)[44];
  c2_y = (real_T (*)[44])ssGetOutputPortSignal(chartInstance->S, 1);
  chartInstance->c2_doneDoubleBufferReInit = TRUE;
  c2_u = sf_mex_dup(c2_st);
  c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)), "y",
                      c2_dv0);
  for (c2_i1 = 0; c2_i1 < 44; c2_i1++) {
    (*c2_y)[c2_i1] = c2_dv0[c2_i1];
  }

  chartInstance->c2_is_active_c2_lin_model_PI_MRAC_Sim_CASE2 =
    c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
    "is_active_c2_lin_model_PI_MRAC_Sim_CASE2");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_lin_model_PI_MRAC_Sim_CASE2(chartInstance);
  ...
  (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance)
{
  ...
  real_T (*c2_c_A)[121];
  real_T (*c2_c_b)[44];
  c2_c_A = (real_T (*)[121])ssGetInputPortSignal(chartInstance->S, 1);
  c2_b_y = (real_T (*)[44])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_c_b = (real_T (*)[44])ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  for (c2_i2 = 0; c2_i2 < 44; c2_i2++) {
    _SFD_DATA_RANGE_CHECK((*c2_c_b)[c2_i2], 0U);
  }
  ...
  for (c2_i4 = 0; c2_i4 < 121; c2_i4++) {
    _SFD_DATA_RANGE_CHECK((*c2_c_A)[c2_i4], 2U);
  }

  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  for (c2_i5 = 0; c2_i5 < 44; c2_i5++) {
    c2_b[c2_i5] = (*c2_c_b)[c2_i5];
  }

  for (c2_i6 = 0; c2_i6 < 121; c2_i6++) {
    c2_A[c2_i6] = (*c2_c_A)[c2_i6];
  }
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_nargout, 1U, c2_d_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c2_b, 2U, c2_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c2_A, 3U, c2_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c2_y, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 4);
  for (c2_i7 = 0; c2_i7 < 44; c2_i7++) {
    c2_b_b[c2_i7] = c2_b[c2_i7];
  }
  ...
  c2_mldivide(chartInstance, c2_b_b, c2_b_A, c2_dv1);
  for (c2_i9 = 0; c2_i9 < 44; c2_i9++) {
    c2_y[c2_i9] = c2_dv1[c2_i9];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -4);
  sf_debug_symbol_scope_pop();
  for (c2_i10 = 0; c2_i10 < 44; c2_i10++) {
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance;
  chartInstance = (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *)
    chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  c2_i11 = 0;
  for (c2_i12 = 0; c2_i12 < 11; c2_i12++) {
    for (c2_i13 = 0; c2_i13 < 4; c2_i13++) {
      c2_b_inData[c2_i13 + c2_i11] = (*(real_T (*)[44])c2_inData)[c2_i13 +
        c2_i11];
    }
  ...
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 2, 4, 11));
  ...
  real_T c2_y[44])
{
  real_T c2_dv2[44];
  int32_T c2_i17;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv2, 1, 0, 0U, 1, 0U, 2, 4, 11);
  for (c2_i17 = 0; c2_i17 < 44; c2_i17++) {
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i19 = 0; c2_i19 < 11; c2_i19++) {
    for (c2_i20 = 0; c2_i20 < 4; c2_i20++) {
      (*(real_T (*)[44])c2_outData)[c2_i20 + c2_i18] = c2_b_y[c2_i20 + c2_i18];
    }
  ...
  *c2_inData)
{
  ...
  for (c2_i22 = 0; c2_i22 < 11; c2_i22++) {
    for (c2_i23 = 0; c2_i23 < 11; c2_i23++) {
      c2_b_inData[c2_i23 + c2_i21] = (*(real_T (*)[121])c2_inData)[c2_i23 +
        c2_i21];
    }
  ...
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 2, 11, 11));
  sf_mex_assign(&c2_mxArrayOutData, c2_y);
  return c2_mxArrayOutData;
}
  ...
  *c2_inData)
{
  ...
  for (c2_i28 = 0; c2_i28 < 4; c2_i28++) {
    for (c2_i29 = 0; c2_i29 < 11; c2_i29++) {
      c2_b_inData[c2_i29 + c2_i27] = (*(real_T (*)[44])c2_inData)[c2_i29 +
        c2_i27];
    }
...
const mxArray *sf_c2_lin_model_PI_MRAC_Sim_CASE2_get_eml_resolved_functions_info
  (void)
{
  ...
  *chartInstance, real_T c2_A[44], real_T c2_B[121], real_T c2_Y[44])
{
  ...
  for (c2_j = 1; c2_j < 5; c2_j++) {
    c2_b_j = c2_j;
    for (c2_i38 = 0; c2_i38 < 44; c2_i38++) {
      c2_c_A[c2_i38] = c2_b_A[c2_i38];
    }
  ...
  while ((exitg1 == 0U) && (c2_c_k <= 4.0)) {
    ...
    if (c2_s_y + c2_t_y <= c2_tol) {
      ...
      for (c2_i44 = 0; c2_i44 < 14; c2_i44++) {
        c2_b_str[c2_i44] = c2_str[c2_i44];
      }
  ...
  for (c2_d_j = 1.0; c2_d_j <= 4.0; c2_d_j++) {
    ...
    c2_tauj = c2_tau[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
      ("", c2_e_j), 1, 4, 1, 0) - 1];
    if (c2_tauj != 0.0) {
      for (c2_e_k = 1.0; c2_e_k <= 11.0; c2_e_k++) {
        c2_d_k = c2_e_k;
        c2_wj = c2_b_B[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", c2_e_j), 1, 11, 1, 0) + 11 *
                        (_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", c2_d_k), 1, 11, 2, 0) - 1)) - 1];
        c2_d4 = c2_e_j + 1.0;
        ...
        if (c2_wj != 0.0) {
          c2_b_B[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                    c2_e_j), 1, 11, 1, 0) + 11 * (_SFD_EML_ARRAY_BOUNDS_CHECK("",
                    (int32_T)_SFD_INTEGER_CHECK("", c2_d_k), 1, 11, 2, 0) - 1))
            - 1] = c2_b_B[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", c2_e_j), 1, 11, 1, 0) + 11 *
                           (_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
            _SFD_INTEGER_CHECK("", c2_d_k), 1, 11, 2, 0) - 1)) - 1] - c2_wj;
          c2_d5 = c2_e_j + 1.0;
          for (c2_e_i = c2_d5; c2_e_i <= 11.0; c2_e_i++) {
            ...
            c2_b_B[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
                    ...
                    (_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
                      ("", c2_d_k), 1, 11, 2, 0) - 1)) - 1] = c2_b_B
              [(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                  c2_d_i), 1, 11, 1, 0) + 11 * (_SFD_EML_ARRAY_BOUNDS_CHECK("",
                  (int32_T)_SFD_INTEGER_CHECK("", c2_d_k), 1, 11, 2, 0) - 1)) -
              1] - c2_y_y;
          }
        }
  ...
  c2_rr = c2_rankR;
  for (c2_f_k = 1.0; c2_f_k <= 11.0; c2_f_k++) {
    c2_d_k = c2_f_k;
    for (c2_f_i = 1.0; c2_f_i <= c2_rr; c2_f_i++) {
      ...
      c2_Y[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
              (real_T)c2_jpvt[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
               _SFD_INTEGER_CHECK("", c2_d_i), 1, 4, 1, 0) - 1]), 1, 4, 1, 0) +
            ((_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                c2_d_k), 1, 11, 2, 0) - 1) << 2)) - 1] = c2_b_B
        [(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("", c2_d_i),
    ...
    for (c2_f_j = c2_b_rr; c2_f_j >= 1.0; c2_f_j += -1.0) {
      c2_e_j = c2_f_j;
      c2_pj = c2_jpvt[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
        _SFD_INTEGER_CHECK("", c2_e_j), 1, 4, 1, 0) - 1];
      c2_v_x = c2_Y[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
                      ("", (real_T)c2_pj), 1, 4, 1, 0) +
                     ((_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
        _SFD_INTEGER_CHECK("", c2_d_k), 1, 11, 2, 0) - 1) << 2)) - 1];
      ...
      c2_Y[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
              (real_T)c2_pj), 1, 4, 1, 0) + ((_SFD_EML_ARRAY_BOUNDS_CHECK("",
               (int32_T)_SFD_INTEGER_CHECK("", c2_d_k), 1, 11, 2, 0) - 1) << 2))
        - 1] = c2_b_z;
      c2_loop_ub = c2_e_j - 1.0;
      for (c2_g_i = 1.0; c2_g_i <= c2_loop_ub; c2_g_i++) {
        c2_d_i = c2_g_i;
        c2_ab_a = c2_Y[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)c2_pj), 1, 4, 1, 0) +
                        ((_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", c2_d_k), 1, 11, 2, 0) - 1) << 2)) - 1];
        ...
        c2_Y[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                (real_T)c2_jpvt[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
                 _SFD_INTEGER_CHECK("", c2_d_i), 1, 4, 1, 0) - 1]), 1, 4, 1, 0)
              + ((_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                  c2_d_k), 1, 11, 2, 0) - 1) << 2)) - 1] = c2_Y
          [(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
              (real_T)c2_jpvt[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
               _SFD_INTEGER_CHECK("", c2_d_i), 1, 4, 1, 0) - 1]), 1, 4, 1, 0) +
            ((_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                c2_d_k), 1, 11, 2, 0) - 1) << 2)) - 1] - c2_cb_y;
      }
    }
  }
}
  ...
  c2_b_work[4])
{
  int32_T c2_i54;
  int32_T c2_i55;
  for (c2_i54 = 0; c2_i54 < 44; c2_i54++) {
    c2_b_C[c2_i54] = c2_C[c2_i54];
  }

  for (c2_i55 = 0; c2_i55 < 4; c2_i55++) {
    c2_b_work[c2_i55] = c2_work[c2_i55];
  }
  ...
  real_T c2_x[44], int32_T c2_ix0, real_T c2_y[4], real_T c2_b_y[4])
{
  ...
  for (c2_i56 = 0; c2_i56 < 4; c2_i56++) {
    c2_b_y[c2_i56] = c2_y[c2_i56];
  }

  for (c2_i57 = 0; c2_i57 < 44; c2_i57++) {
    c2_b_A[c2_i57] = c2_A[c2_i57];
  }

  for (c2_i58 = 0; c2_i58 < 44; c2_i58++) {
    c2_b_x[c2_i58] = c2_x[c2_i58];
  }
  ...
  real_T c2_b_y[4])
{
  ...
  for (c2_i59 = 0; c2_i59 < 4; c2_i59++) {
    c2_b_y[c2_i59] = c2_y[c2_i59];
  }

  for (c2_i60 = 0; c2_i60 < 44; c2_i60++) {
    c2_b_A[c2_i60] = c2_A[c2_i60];
  }

  for (c2_i61 = 0; c2_i61 < 44; c2_i61++) {
  ...
  [44], int32_T c2_ia0, int32_T c2_lda, real_T c2_b_A[44])
{
  ...
  int32_T c2_i63;
  real_T c2_b_y[4];
  for (c2_i62 = 0; c2_i62 < 44; c2_i62++) {
    c2_b_A[c2_i62] = c2_A[c2_i62];
  }

  for (c2_i63 = 0; c2_i63 < 4; c2_i63++) {
    c2_b_y[c2_i63] = c2_y[c2_i63];
  }
  ...
  *chartInstance, real_T c2_varargin_2, char_T c2_varargin_3[14])
{
  ...
  for (c2_i65 = 0; c2_i65 < 14; c2_i65++) {
    c2_c_u[c2_i65] = c2_varargin_3[c2_i65];
  }
  ...
  char_T c2_y[14])
{
  ...
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_cv1, 1, 10, 0U, 1, 0U, 2, 1,
                14);
  for (c2_i66 = 0; c2_i66 < 14; c2_i66++) {
    c2_y[c2_i66] = c2_cv1[c2_i66];
  }
   ...
   c2_b_is_active_c2_lin_model_PI_MRAC_Sim_CASE2, const char_T *c2_identifier)
{
  ...
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_lin_model_PI_MRAC_Sim_CASE2), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_lin_model_PI_MRAC_Sim_CASE2);
  return c2_y;
}
  ...
  if (c2_lastv > 0) {
    ...
    for (c2_i69 = 0; c2_i69 < 4; c2_i69++) {
      for (c2_i70 = 0; c2_i70 < 11; c2_i70++) {
        c2_b_C[c2_i70 + c2_i68] = c2_C[c2_i70 + c2_i68];
      }
    ...
    for (c2_i72 = 0; c2_i72 < 4; c2_i72++) {
      for (c2_i73 = 0; c2_i73 < 11; c2_i73++) {
        c2_c_C[c2_i73 + c2_i71] = c2_C[c2_i73 + c2_i71];
      }
    ...
    if ((real_T)c2_f_m < 1.0) {
      ...
      for (c2_i74 = 0; c2_i74 < 4; c2_i74++) {
        c2_b_work[c2_i74] = c2_work[c2_i74];
      }
  ...
  real_T c2_x[44], int32_T c2_ix0, real_T c2_y[4])
{
  ...
  int32_T c2_i76;
  real_T c2_b_x[44];
  for (c2_i75 = 0; c2_i75 < 44; c2_i75++) {
    c2_b_A[c2_i75] = c2_A[c2_i75];
  }

  for (c2_i76 = 0; c2_i76 < 44; c2_i76++) {
...
/* SFunction Glue Code */
void sf_c2_lin_model_PI_MRAC_Sim_CASE2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_lin_model_PI_MRAC_Sim_CASE2_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_lin_model_PI_MRAC_Sim_CASE2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_lin_model_PI_MRAC_Sim_CASE2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_lin_model_PI_MRAC_Sim_CASE2_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c2_y)[44];
          real_T (*c2_A)[121];
          c2_A = (real_T (*)[121])ssGetInputPortSignal(chartInstance->S, 1);
          c2_y = (real_T (*)[44])ssGetOutputPortSignal(chartInstance->S, 1);
          c2_b = (real_T (*)[44])ssGetInputPortSignal(chartInstance->S, 0);
...
static void sf_opaque_initialize_c2_lin_model_PI_MRAC_Sim_CASE2(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_lin_model_PI_MRAC_Sim_CASE2
    ((SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct*) chartInstanceVar);
  initialize_c2_lin_model_PI_MRAC_Sim_CASE2
    ((SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_lin_model_PI_MRAC_Sim_CASE2(void
  *chartInstanceVar)
{
  enable_c2_lin_model_PI_MRAC_Sim_CASE2
    ((SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_lin_model_PI_MRAC_Sim_CASE2(void
  *chartInstanceVar)
{
  disable_c2_lin_model_PI_MRAC_Sim_CASE2
    ((SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_lin_model_PI_MRAC_Sim_CASE2(void
  *chartInstanceVar)
{
  sf_c2_lin_model_PI_MRAC_Sim_CASE2
    ((SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_lin_model_PI_MRAC_Sim_CASE2
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_lin_model_PI_MRAC_Sim_CASE2
    ((SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_lin_model_PI_MRAC_Sim_CASE2();/* state var info */
...
extern void sf_internal_set_sim_state_c2_lin_model_PI_MRAC_Sim_CASE2(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_lin_model_PI_MRAC_Sim_CASE2
    ((SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_lin_model_PI_MRAC_Sim_CASE2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_lin_model_PI_MRAC_Sim_CASE2(S);
}

static void sf_opaque_set_sim_state_c2_lin_model_PI_MRAC_Sim_CASE2(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_lin_model_PI_MRAC_Sim_CASE2(S, st);
}

static void sf_opaque_terminate_c2_lin_model_PI_MRAC_Sim_CASE2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_lin_model_PI_MRAC_Sim_CASE2
      ((SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_lin_model_PI_MRAC_Sim_CASE2
    ((SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_lin_model_PI_MRAC_Sim_CASE2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_lin_model_PI_MRAC_Sim_CASE2
      ((SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_lin_model_PI_MRAC_Sim_CASE2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"lin_model_PI_MRAC_Sim_CASE2",
      "lin_model_PI_MRAC_Sim_CASE2",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"lin_model_PI_MRAC_Sim_CASE2",
                "lin_model_PI_MRAC_Sim_CASE2",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "lin_model_PI_MRAC_Sim_CASE2","lin_model_PI_MRAC_Sim_CASE2",2,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"lin_model_PI_MRAC_Sim_CASE2",
        "lin_model_PI_MRAC_Sim_CASE2",2,2);
      sf_mark_chart_reusable_outputs(S,"lin_model_PI_MRAC_Sim_CASE2",
        "lin_model_PI_MRAC_Sim_CASE2",2,1);
    }
...
static void mdlRTW_c2_lin_model_PI_MRAC_Sim_CASE2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_lin_model_PI_MRAC_Sim_CASE2(SimStruct *S)
{
  SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *chartInstance;
  chartInstance = (SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct *)malloc
    (sizeof(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_lin_model_PI_MRAC_Sim_CASE2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_lin_model_PI_MRAC_Sim_CASE2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_lin_model_PI_MRAC_Sim_CASE2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_lin_model_PI_MRAC_Sim_CASE2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_lin_model_PI_MRAC_Sim_CASE2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_lin_model_PI_MRAC_Sim_CASE2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_lin_model_PI_MRAC_Sim_CASE2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_lin_model_PI_MRAC_Sim_CASE2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_lin_model_PI_MRAC_Sim_CASE2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_lin_model_PI_MRAC_Sim_CASE2;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_lin_model_PI_MRAC_Sim_CASE2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_lin_model_PI_MRAC_Sim_CASE2;
...
void c2_lin_model_PI_MRAC_Sim_CASE2_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_lin_model_PI_MRAC_Sim_CASE2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_lin_model_PI_MRAC_Sim_CASE2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_lin_model_PI_MRAC_Sim_CASE2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_lin_model_PI_MRAC_Sim_CASE2_method_dispatcher.\n"
