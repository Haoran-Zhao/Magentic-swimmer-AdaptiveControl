...
static void c2_emlrt_marshallIn(SFc2_untitledInstanceStruct *chartInstance,
  const mxArray *c2_x, const char_T *c2_identifier, real_T c2_y[3]);
...
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_mldivide(SFc2_untitledInstanceStruct *chartInstance, real_T c2_A
  [9], real_T c2_B[3], real_T c2_Y[3]);
static void c2_eml_warning(SFc2_untitledInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T (*c2_x)[3];
  c2_x = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
...
static void sf_c2_untitled(SFc2_untitledInstanceStruct *chartInstance)
{
  ...
  real_T (*c2_c_A)[9];
  real_T (*c2_c_b)[3];
  c2_c_A = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
  c2_b_x = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_c_b = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  for (c2_i3 = 0; c2_i3 < 3; c2_i3++) {
    _SFD_DATA_RANGE_CHECK((*c2_b_x)[c2_i3], 1U);
  }
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_nargout, 1U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c2_b, 2U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c2_A, 3U, c2_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c2_x, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c2_i8 = 0; c2_i8 < 3; c2_i8++) {
    c2_b_b[c2_i8] = c2_b[c2_i8];
  }

  c2_mldivide(chartInstance, c2_b_A, c2_b_b, c2_dv1);
  for (c2_i9 = 0; c2_i9 < 3; c2_i9++) {
    c2_x[c2_i9] = c2_dv1[c2_i9];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -3);
  sf_debug_symbol_scope_pop();
  for (c2_i10 = 0; c2_i10 < 3; c2_i10++) {
    (*c2_b_x)[c2_i10] = c2_x[c2_i10];
  }
...
const mxArray *sf_c2_untitled_get_eml_resolved_functions_info(void)
{
  ...
  (*c2_b_info)[6].fileTimeLo = 1639026944U;
  ...
  (*c2_b_info)[7].fileTimeLo = 529702400U;
  (*c2_b_info)[7].fileTimeHi = 30114350U;
  (*c2_b_info)[7].mFileTimeLo = 0U;
  (*c2_b_info)[7].mFileTimeHi = 0U;
  (*c2_b_info)[8].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_lusolve.m!warn_singular";
  (*c2_b_info)[8].name = "eml_warning";
  (*c2_b_info)[8].dominantType = "char";
  (*c2_b_info)[8].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_warning.m";
  (*c2_b_info)[8].fileTimeLo = 2679026944U;
  (*c2_b_info)[8].fileTimeHi = 30108061U;
  ...
  (*c2_b_info)[9].fileTimeLo = 2619026944U;
  (*c2_b_info)[9].fileTimeHi = 30108061U;
  ...
  [9], real_T c2_B[3], real_T c2_Y[3])
{
  ...
  c2_i_y = c2_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c2_r1), 1, 3, 1, 0) - 1];
  c2_s_x = c2_r_x;
  c2_j_y = c2_i_y;
  c2_b_z = c2_s_x / c2_j_y;
  c2_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("", (real_T)
  ...
  c2_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("", (real_T)
    ...
    _SFD_INTEGER_CHECK("", (real_T)c2_r2), 1, 3, 1, 0) + 2] - c2_k_y;
  ...
  c2_b_b = c2_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c2_r1), 1, 3, 1, 0) + 2];
  c2_l_y = c2_b_a * c2_b_b;
  c2_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("", (real_T)
    c2_r3), 1, 3, 1, 0) + 2] = c2_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
    _SFD_INTEGER_CHECK("", (real_T)c2_r3), 1, 3, 1, 0) + 2] - c2_l_y;
  ...
  c2_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("", (real_T)
    ...
    _SFD_INTEGER_CHECK("", (real_T)c2_r2), 1, 3, 1, 0) + 5] - c2_m_y;
  ...
  c2_eb_x = c2_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c2_r3), 1, 3, 1, 0) + 2];
  c2_s_y = c2_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c2_r2), 1, 3, 1, 0) + 2];
  c2_fb_x = c2_eb_x;
  c2_t_y = c2_s_y;
  c2_c_z = c2_fb_x / c2_t_y;
  c2_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("", (real_T)
  ...
  c2_u_y = c2_e_a * c2_e_b;
  c2_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("", (real_T)
    c2_r3), 1, 3, 1, 0) + 5] = c2_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
    _SFD_INTEGER_CHECK("", (real_T)c2_r3), 1, 3, 1, 0) + 5] - c2_u_y;
  guard1 = FALSE;
  guard2 = FALSE;
...
static void c2_eml_warning(SFc2_untitledInstanceStruct *chartInstance)
{
  ...
  char_T c2_u[27];
  const mxArray *c2_y = NULL;
  for (c2_i23 = 0; c2_i23 < 27; c2_i23++) {
    c2_u[c2_i23] = c2_varargin_1[c2_i23];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1705252684U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(769720562U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1890938471U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(698798621U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(3607490255U);
    pr[1] = (double)(473245092U);
    pr[2] = (double)(3407174609U);
    pr[3] = (double)(3225177827U);
...
static const mxArray *sf_get_sim_state_info_c2_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"x\",},{M[8],M[0],T\"is_active_c2_untitled\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c2_x)[3];
          real_T (*c2_A)[9];
          c2_A = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
          c2_x = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
          c2_b = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"untitled","untitled",2,2);
  ...
  ssSetChecksum0(S,(3628333404U));
  ssSetChecksum1(S,(1340334322U));
  ssSetChecksum2(S,(3364552223U));
  ssSetChecksum3(S,(3385052224U));
